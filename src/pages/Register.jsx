            ...
            {password && (
              <div className="p-3 bg-black/40 rounded-lg border border-white/10">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-white/80">Sicurezza password:</span>
                  <span
                  ...
                  {Object.entries({
                    ...
                    <div
                      ...
                      className={`flex items-center gap-2 ${
                        passwordCriteria[key] ? 'text-green-400' : 'text-white/60'
                      }`}
                    >
                      <span
                        className={`w-2 h-2 rounded-full ${
                          passwordCriteria[key] ? 'bg-green-400' : 'bg-white/30'
                        }`}
                      ></span>
                      {text}
                    </div>
