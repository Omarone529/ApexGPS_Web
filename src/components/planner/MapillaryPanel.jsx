...
const MapillaryPanel = ({ lat, lon, onClose }) => {
    ...
    return (
        <div className="absolute bottom-6 right-3 left-3 sm:right-6 sm:left-auto sm:w-96 z-[1500] bg-[#FAF7F2] rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            {/* Header */}
