  ...
  return (
    <div className="planner-form-card">
      <div className="form-section">
        <h3>
          <span className="section-number">1</span> Dettagli
        </h3>
        <input
      ...
      <div className="form-section">
        <h3>
          <span className="section-number">2</span> Percorso
        </h3>
        <input
          className="form-input"
              ...
              {form.waypoints.length > 1 && (
                <button
                  ...
                  onClick={() =>
                    updateForm(
                      'waypoints',
                      form.waypoints.filter((_, idx) => idx !== i)
                    )
                  }
                >
                  ×
      ...
      <div className="form-section">
        <h3>
          <span className="section-number">3</span> Impostazioni
        </h3>
