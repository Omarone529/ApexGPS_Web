            ...
            {columns.map(c => (
              ...
              >
                <ul className="pb-5 pt-2 space-y-3">
                  {c.items.map(it => (
                    <li key={it.label}>
                      <Link to={it.to} className="text-white/70 hover:text-white transition">
                        {it.label}
                      </Link>
                    </li>
                  ))}
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <SocialIcon
                ...
                icon={<FaInstagram />}
              />
              <SocialIcon label="YouTube" href="https://www.youtube.com/" icon={<FaYoutube />} />
              <SocialIcon label="Facebook" href="https://www.facebook.com/" icon={<FaFacebook />} />
            </div>
          </div>
        </div>
