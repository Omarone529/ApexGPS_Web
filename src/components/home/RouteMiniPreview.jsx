...
export default function RouteMiniPreview() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-2xl rounded-3xl border border-white/10 bg-white/6 shadow-2xl shadow-black/40 overflow-hidden backdrop-blur"
    >
      <div className="p-5">
        <div className="relative w-full aspect-5/3 rounded-2xl overflow-hidden">
          ...
          >
            <motion.path
              ...
              style={{ pathLength: scrollYProgress, pathOffset: progress, pathSpacing: 1 }}
            />
            ...
            <g transform={`translate(${dot.x} ${dot.y})`}>
              ...
              <circle r="10.5" fill="none" stroke="rgba(0,0,0,0.18)" strokeWidth="3" />
            </g>
          </svg>
